...
for EPOCHS in 3 4 5 ; do 
	for LR in 2e-5 3e-5 5e-5; do
		for BATCH_SZ in 16 32 ; do
			...
			DATA_DIR=mednli #Modify this to be the path to the MedNLI data
			OUTPUT_DIR=outputs #Modify this to be the path to your output directory
			CLINICAL_BERT_LOC=PATH/TO/CLINICAL/BERT/MODEL #Modify this to be the path to the clinical BERT model

			echo $OUTPUT_DIR

			BERT_MODEL=bert-base-cased # You can change this to biobert or bert-base-cased
